...
public class PhotoServiceImpl implements PhotoService {
    ...
    @Override
    public PhotoDTO addLocationPhoto(@Valid @NonNull SavePhotoModel model) throws EntityNotFoundException {
    ...
    @Override
    public PhotoDTO updatePhoto(@Valid @NonNull UpdatePhotoModel model) throws EntityNotFoundException {
